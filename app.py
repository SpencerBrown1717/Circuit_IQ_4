...
def process_datasheet(file_path):
    ...
    try:
        component = datasheet_extractor.extract_from_file(file_path)
        return component
    except Exception as e:
...
def api_extract_from_datasheet():
    ...
    try:
        if 'file' in request.files:
            ...
            component = datasheet_extractor.extract_from_text(datasheet_text)
            return jsonify({
                "status": "success", 
                "component": component
            })
...
if __name__ == '__main__':
    ...
    print(f"  - POST /api/extract_from_datasheet")
    print(f"  - POST /api/design_pcb")
